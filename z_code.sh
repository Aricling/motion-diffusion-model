...
python -m train.train_mdm \
    --save_dir save/train_mdm_w_motion_token_split_info_inject_v2 \
    --dataset humanml \
    --diffusion_steps 50 \
    --arch trans_dec \
...
python -m eval.eval_humanml \
    --model_path /home/mengqing/usr/motion-diffusion-model/save/train_mdm_w_motion_token_gt/model000600000.pt \
    --device 0
