...
python -m train.train_mdm \
    --save_dir save_end2end_training/1001_train_mdm_clip_pool49_use_cls_token_clip_unfreeze_last_n_layers_3_add_supervision_loss_all_batch_using_lora_clip_out \
    --dataset humanml \
    --diffusion_steps 50 \
    --arch trans_dec \
