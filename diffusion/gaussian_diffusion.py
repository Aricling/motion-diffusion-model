...
class GaussianDiffusion:
    ...
    def training_losses(self, model, x_start, t, model_kwargs=None, noise=None, dataset=None, pooling_size=1):
        """
        ...
        enc = model.model
        mask = model_kwargs['y']['mask'][...,::pooling_size]    ## 这个其实就和motion的长度是有关系的
